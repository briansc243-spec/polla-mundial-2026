...
function renderMyPredictions() {
    ...
    function scoreBlockHtml(pred, result) {
        if (result) {
            ...
            <div style="text-align:center; min-width:80px;">
                ...
                ${etLine}
                <div style="font-size:0.72rem;color:#A0A8C0;margin-top:2px;">tu pick: ${pred.score1}–${pred.score2}</div>
            </div>`;
        }
        return `
            <div style="text-align:center; min-width:80px;">
    ...
    for (const key of PREDICTIONS_TAB_ROUNDS) {
        ...
        roundPicks.sort((a, b) => new Date(b.match.dateTime) - new Date(a.match.dateTime));
...
const COUNTRY_FLAG = { ARG:'🇦🇷', BRA:'🇧🇷', FRA:'🇫🇷', ENG:'🇬🇧', ESP:'🇪🇸', POR:'🇵🇹', GER:'🇩🇪', NED:'🇳🇱', URU:'🇺🇾', COL:'🇨🇴', MEX:'🇲🇽', USA:'🇺🇸', CRO:'🇭🇷', ITA:'🇮🇹', BEL:'🇧🇪', DEN:'🇩🇰', SUI:'🇨🇭', SEN:'🇸🇳', JAP:'🇯🇵', KOR:'🇰🇷', MAR:'🇲🇦', MOR:'🇲🇦', AUS:'🇦🇺', GHA:'🇬🇭', CAN:'🇨🇦', ECU:'🇪🇨', PAN:'🇵🇦', PAR:'🇵🇾', BOL:'🇧🇴', SAU:'🇸🇦', IRN:'🇮🇷', TUN:'🇹🇳', CMR:'🇨🇲', NGA:'🇳🇬', EGY:'🇪🇬', SLO:'🇸🇮', SVK:'🇸🇰', AUT:'🇦🇹', SCO:'🏴󠁧󠁢󠁳󠁣󠁴󠁿', WAL:'🏴󠁧󠁢󠁷󠁬󠁳󠁿', POL:'🇵🇱', SRB:'🇷🇸', HUN:'🇭🇺', ROM:'🇷🇴', UKR:'🇺🇦', TUR:'🇹🇷', GRE:'🇬🇷', ALB:'🇦🇱', GEO:'🇬🇪', VEN:'🇻🇪', PER:'🇵🇪', CHI:'🇨🇱', HON:'🇭🇳', CRC:'🇨🇷', QAT:'🇶🇦', UAE:'🇦🇪', KSA:'🇸🇦', IRQ:'🇮🇶', JOR:'🇯🇴', NOR:'🇳🇴', NZL:'🇳🇿', RDC:'🇨🇩', COD:'🇨🇩', JAM:'🇯🇲', VEN:'🇻🇪', ALG:'🇩🇿', CIV:'🇨🇮', MLI:'🇲🇱', SUD:'🇸🇩', ZIM:'🇿🇼', ZAM:'🇿🇲', TAN:'🇹🇿', UGA:'🇺🇬', KEN:'🇰🇪', ETH:'🇪🇹', ANG:'🇦🇴', MOZ:'🇲🇿', BUR:'🇧🇫', TOG:'🇹🇬', BEN:'🇧🇯', GAB:'🇬🇦' };
